            ...
            <ScrollView>
                ...
                <View style={theme.styles.VueCollapse}>
                    ...
                    <CollapsibleView
                        ...
                        arrowStyling={theme.styles.Arrow} >
                        <View  style={theme.styles.VueCollapseDetail}>
                            <Text style={theme.styles.TexteCollapse}>{product.product.ingredients_text === undefined || product.product.ingredients_text == '' ? "Non renseigné." : product.product.ingredients_text+'\n'}</Text>
                        </View>
                    </CollapsibleView>
